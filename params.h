...
class params
{
  ...
  bool IsBox_; //0 if parameteres belong to InOut, and 1 if parameters belong to box simulation
  double epsilon_;
 ...
 public:
  ...
  bool IsBox() const{ return IsBox_; }
  void Set_Np ( int n ) { N0_ = n; }

  //non dims:

  int N0() const{ return N0_; } // Initial total number of particles
