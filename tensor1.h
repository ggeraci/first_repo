...
class tensor1 
{
  ...
  void make_reduced_mean_zero(); //make reduced_mean value of T.x, T.y, and T.z zero
  ...
  void reduceX(); //reduce 3D tensor to a 1D array along x-direction.
  //post process
  void Equal_TKE2(tensor1&,tensor1&,tensor0&); //compute components of TKE based on Favre average <Ru''u''>
  void Equal_TKE(tensor1&,tensor0&); //compute components of TKE
  void Equal_UiUi2(tensor1&,tensor1&,tensor0&); //compute components of UiUi based on Favre average <u''u''>
  void Equal_UiUi(tensor1&,tensor0&); //compute components of UiUi
  void Equal_Cor_Rho_U(tensor1&,tensor0&); // <U' Rho'>
  //arithmatics
