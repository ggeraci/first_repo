...
gridsize::gridsize(params* par,proc *P)
{
  ...
  /*
  il_=(P->I()<(Nx_tot_%P->NX()))?P->I()*(Nx_tot_/P->NX()+1):(Nx_tot_%P->NX())*(Nx_tot_/P->NX()+1)+(P->I()-(Nx_tot_%P->NX()))*(Nx_tot_/P->NX());
  ih_=(P->I()<(Nx_tot_%P->NX()))?il_+Nx_tot_/P->NX():il_+Nx_tot_/P->NX()-1;
  jl_=(P->J()<(Ny_tot_%P->NY()))?P->J()*(Ny_tot_/P->NY()+1):(Ny_tot_%P->NY())*(Ny_tot_/P->NY()+1)+(P->J()-(Ny_tot_%P->NY()))*(Ny_tot_/P->NY());
  jh_=(P->J()<(Ny_tot_%P->NY()))?jl_+Ny_tot_/P->NY():jl_+Ny_tot_/P->NY()-1;
  kl_=(P->K()<(Nz_tot_%P->NZ()))?P->K()*(Nz_tot_/P->NZ()+1):(Nz_tot_%P->NZ())*(Nz_tot_/P->NZ()+1)+(P->K()-(Nz_tot_%P->NZ()))*(Nz_tot_/P->NZ());
  kh_=(P->K()<(Nz_tot_%P->NZ()))?kl_+Nz_tot_/P->NZ():kl_+Nz_tot_/P->NZ()-1;
  */
